...
wrong_filename = "Wrong_titles_2023.txt"
# wrong_filename = "Wrong_titles_2022.txt"
...
# titles = get_titles(pdf, first_page, last_page)
#
# with open(wrong_filename, "w") as file:
...
#     for page, title in titles:
#         if title != "":
#             dict_titles[title] = page
#     file.write(json.dumps(dict_titles, indent=4))
