...
class OmekaAPI:
    ...
    def __get_api_url_for_endpoint__(self, endpoint):
        # It's needed for superuser tasks
    ...
    def get_geolocation_id_by_address(self, address):
        # If it returns -1, it means that the geolocation doesn't exist
    ...
    def delete_all_items_from_a_collection(self, collection_name):
        # Acho que o get tem limite de tamanho. Pode não ir buscar todos os items
